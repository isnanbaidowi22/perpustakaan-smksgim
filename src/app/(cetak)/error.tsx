 ...
 * ke klien di produksi. Sama seperti `(app)/error.tsx`: struk dan label
 * dibuka di tab baru langsung setelah transaksi, jadi tidak boleh jatuh
 * ke halaman error bawaan Next yang berbahasa Inggris (spec Minor 1).
 */
